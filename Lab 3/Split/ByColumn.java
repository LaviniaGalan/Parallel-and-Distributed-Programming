...
public class ByColumn extends Thread {
    ...
    public ByColumn(int startRow, int startColumn, int nrElements, Matrix resultMatrix, Matrix matrix1, Matrix matrix2) {
